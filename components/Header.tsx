      ...
      <div className="flex items-center space-x-3">
        <div className="relative hidden sm:block">
          ...
          <input
            ...
            className="bg-gray-700/50 border border-gray-600/50 rounded-xl pl-10 pr-4 py-2.5 min-h-[44px] text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700/70 w-64"
          />
        </div>
